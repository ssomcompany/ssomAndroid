...
public class PullToRefreshRecyclerView extends PullToRefreshBase<RecyclerView> {
    ...
    @Override
    protected void setScrollEvent(RecyclerView mRefreshableView) {

    }

    @Override
    protected void addFooter(RecyclerView mRefreshableView) {

    }

    @Override
    protected void removeFooter(RecyclerView mRefreshableView) {
    ...
    @Override
    protected void removeScrollEvent(RecyclerView mRefreshableView) {
