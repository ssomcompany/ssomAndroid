...
public class RotateLoadingLayout extends LoadingLayout {
    ...
    public RotateLoadingLayout(Context context, Mode mode, Orientation scrollDirection, TypedArray attrs, boolean isDrawer) {
        super(context, mode, scrollDirection, attrs, isDrawer);
    ...
    protected int getDefaultDrawableResId() {
        return R.drawable.temp_indicator_arrow;// temp
    }
